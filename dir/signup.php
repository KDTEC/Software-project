        ...
        <div class="page-body">
          <div class="row">
            <div class="col-sm-12">
              ...
              <div class="card" style="background-color:#1c343c">

                <div class="card-block" style="color:white;margin-top:5px">
                  <form id="main" method="post" action="" enctype="multipart/form-data">

                    <div class="form-group row">
                      <label class="col-sm-2 col-form-label">Patient Name</label>
                      <div class="col-sm-4">
                        <input type="text" class="form-control" name="patientname" id="patientname" placeholder="Enter name...." required="" value="<?php if (isset($_GET['editid'])) {
                    ...
                    <div class="form-group row">
                      ...
                      <div class="col-sm-4">
                        <input type="date" class="form-control" name="admissiondate" id="admissiondate" placeholder="Enter admissiondate...." required="" value="<?php if (isset($_GET['editid'])) {
                                                                                                                                                                    echo $rsedit['admissiondate'];
                                                                                                                                                                  } ?>">
                        <span class="messages"></span>
                      </div>
                    ...
                    <div class="form-group row">
                      ...
                      <div class="col-sm-4">
                        <input class="form-control" type="text" name="city" id="city" value="<?php if (isset($_GET['editid'])) {
                                                                                                echo $rsedit['city'];
                                                                                              } ?>" />
                        <span class="messages"></span>
                      </div>
                      ...
                      <div class="col-sm-4">
                        <input class="form-control" type="text" name="pincode" id="pincode" value="<?php if (isset($_GET['editid'])) {
                                                                                                      echo $rsedit['pincode'];
                                                                                                    } ?>" />
                        <span class="messages"></span>
                      </div>
                    ...
                    <div class="form-group row">
                      ...
                      <div class="col-sm-10">
                        <textarea name="address" id="address" class="form-control"><?php if (isset($_GET['editid'])) {
                                                                                      echo $rsedit['address'];
                                                                                    } ?></textarea>
                      </div>
                    ...
                    <div class="form-group row">
                      ...
                      <div class="col-sm-10">
                        <button type="submit" name="btn_submit" class="btn btn-primary m-b-0">Sign Up</button>
                      </div>
                    </div>
