...
<div class="row col-sm-12"style="color:black;background:inherit;"><h3>Welcome <?php echo $_SESSION['fname']; ?></h3><br><br></div>
<div class="col-xl-3 col-md-6">
<div class="card bg-c-green update-card">
<div class="card-block">
<div class="row align-items-end">
...
<?php if($_SESSION['user'] == 'admin'){ ?>
      ...
      <div class="col-md-6">
        <div class="card">
            ...
            <div class="card-block" style="background-color: white;">
                <div class="ct-chart1 ct-perfect-fourth" style="background-color: white;"></div>
            </div>
        </div>
    </div>
    ...
    <div class="col-md-6">
        <div class="card">
            ...
            <div class="card-block">
                <div class="ct-chart1-patient ct-perfect-fourth" style="background-color: white;"></div>
            </div>
        </div>
    </div>
  </div>
