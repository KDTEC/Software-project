                                ...
                                <div class="card-block" style="color:white;margin-top:5px">
                                    <form id="main" method="post" action="" enctype="multipart/form-data">
                                        ...
                                        <div class="form-group row">
                                            ...
                                            <div class="col-sm-8">
                                                <input type="text" class="form-control" name="treatmenttype" id="treatmenttype" value="<?php if (isset($_GET['editid'])) {
                                        ...
                                        <div class="form-group row">
                                            ...
                                            <div class="col-sm-8">
                                                <input type="text" class="form-control" name="treatmentcost" id="treatmentcost" value="<?php if (isset($_GET['editid'])) {
                                        ...
                                        <div class="form-group row">
                                            ...
                                            <div class="col-sm-8">
                                                <textarea class="form-control" name="note" id="note"><?php if (isset($_GET['editid'])) {
                                                                                                            echo $rsedit['note'];
                                                                                                        } ?></textarea>
                                                <span class="messages"></span>
                                            </div>
