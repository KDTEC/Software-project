                                ...
                                <div class="card-block" style="color:white;margin-top:5px">
                                    <form id="main" method="post" action="" enctype="multipart/form-data">
                                        ...
                                        <div class="form-group row">
                                            ...
                                            <div class="col-sm-8">
                                                <input type="text" class="form-control" name="departmentname" id="departmentname" placeholder="Enter name...." required="" value="<?php if (isset($_GET['editid'])) {
                                                                                                                                                                                        echo $rsedit['departmentname'];
                                                                                                                                                                                    } ?>">
                                        ...
                                        <div class="form-group row">
                                            ...
                                            <div class="col-sm-8">
                                                <textarea name="description" id="description" class="form-control"><?php if (isset($_GET['editid'])) {
